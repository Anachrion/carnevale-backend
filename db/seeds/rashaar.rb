...
hydras_gifts = Catalog::SpecialRule.find_or_create_by!(name: "Hydra's Gifts") do |r|
...
dragging_down = Catalog::SpecialRule.find_or_create_by!(name: "Dragging Down") do |r|
  r.description = "This character may re-roll failed dice rolls when making Drown actions."
end
brawling_tentacles_sr = Catalog::SpecialRule.find_or_create_by!(name: "Brawling Tentacles") do |r|
...
fury_of_dagon = Catalog::SpecialRule.find_or_create_by!(name: "Fury of Dagon") do |r|
...
rent_born = Catalog::SpecialRule.find_or_create_by!(name: "Rent-born") do |r|
...
birth = Catalog::SpecialRule.find_or_create_by!(name: "Birth") do |r|
...
matriarch = Catalog::SpecialRule.find_or_create_by!(name: "Matriarch") do |r|
...
postpartum = Catalog::SpecialRule.find_or_create_by!(name: "Postpartum") do |r|
  r.description = "If one or more Crybabies are killed within 6\" of this character, it gains +3 ATT for the rest of the round."
end
shield_to_the_enlightened = Catalog::SpecialRule.find_or_create_by!(name: "Shield to the Enlightened") do |r|
...
vatican_apostate = Catalog::SpecialRule.find_or_create_by!(name: "Vatican Apostate") do |r|
  r.description = "This character can re-roll the destiny dice when making Attack or Protection rolls."
end
dead_weight = Catalog::SpecialRule.find_or_create_by!(name: "Dead Weight") do |r|
...
hide_of_the_deep = Catalog::SpecialRule.find_or_create_by!(name: "Hide of The Deep") do |r|
...
foetid_pheromones = Catalog::SpecialRule.find_or_create_by!(name: "Foetid Pheromones") do |r|
...
lead_through_fear = Catalog::SpecialRule.find_or_create_by!(name: "Lead Through Fear") do |r|
...
blessing_of_dagon = Catalog::SpecialRule.find_or_create_by!(name: "Blessing of Dagon") do |r|
  r.description = "AURA Command Ability. Until the end of the round, any friendly characters within 6\" gain Expert Offence (2)."
end
herald_of_an_old_god = Catalog::SpecialRule.find_or_create_by!(name: "Herald of an Old God") do |r|
...
serpentine = Catalog::SpecialRule.find_or_create_by!(name: "Serpentine") do |r|
...
swallow_whole = Catalog::SpecialRule.find_or_create_by!(name: "Swallow Whole") do |r|
...
grasp_of_the_abyss = Catalog::SpecialRule.find_or_create_by!(name: "Grasp of the Abyss") do |r|
...
rip_apart = Catalog::SpecialRule.find_or_create_by!(name: "Rip Apart") do |r|
  r.description = "When one of this character's Tentacles kills an enemy character, this character replenishes 1 Will Point."
end
part_of_the_whole = Catalog::SpecialRule.find_or_create_by!(name: "Part of the Whole") do |r|
...
fanaticism_for_dagon = Catalog::SpecialRule.find_or_create_by!(name: "Fanaticism For Dagon") do |r|
...
truth_of_dagon = Catalog::SpecialRule.find_or_create_by!(name: "Truth of Dagon") do |r|
...
dagonite_baptism = Catalog::SpecialRule.find_or_initialize_by(spell_name: "Dagonite Baptism").tap do |r|
  r.name              = ""
...
patient_hunter = Catalog::SpecialRule.find_or_create_by!(name: "Patient Hunter") do |r|
  r.description = "If this character exits water and charges in the same action, it counts as charging from above."
end
bolster_your_faith = Catalog::SpecialRule.find_or_create_by!(name: "Bolster Your Faith") do |r|
  r.description = "AURA Command Ability. Until the end of the round, all friendly characters within 3\" gain +1 PROTECTION."
end
sacrifice = Catalog::SpecialRule.find_or_create_by!(name: "Sacrifice") do |r|
...
prove_yourselves_to_dagon = Catalog::SpecialRule.find_or_create_by!(name: "Prove Yourselves to Dagon!") do |r|
...
eldritch_incense = Catalog::SpecialRule.find_or_create_by!(name: "Eldritch Incense") do |r|
  r.description = "Any friendly character making a Combat action within 3\" gains Fear (0) for that action."
end
burned_flesh = Catalog::SpecialRule.find_or_create_by!(name: "Burned Flesh") do |r|
  r.description = "If a Combat action with the Burning Brand results in no Protection roll for the target, add 2 to the Damage."
end
herding = Catalog::SpecialRule.find_or_create_by!(name: "Herding") do |r|
...
encouragement_handler = Catalog::SpecialRule.find_or_create_by!(name: "Encouragement") do |r|
...
spawn_3lp = Catalog::SpecialRule.find_or_create_by!(name: "Spawn - 3LP") do |r|
...
living_vessel = Catalog::SpecialRule.find_or_create_by!(name: "Living Vessel") do |r|
...
climbing_suckers = Catalog::SpecialRule.find_or_create_by!(name: "Climbing Suckers") do |r|
  r.description = "When this character makes a DEXTERITY roll as part of a Run/Climb action, it counts all fumbles as failures."
end
gift_of_the_elder_gods = Catalog::SpecialRule.find_or_create_by!(name: "Gift of the Elder Gods") do |r|
...
brawling_tentacles_w = Catalog::Weapon.find_or_create_by!(name: "Brawling Tentacles") { |w| w.range = 0;  w.evasion = 1;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Stun"] }
ornate_trident       = Catalog::Weapon.find_or_create_by!(name: "Ornate Trident")     { |w| w.range = 2;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Aquatic"] }
ancient_trident      = Catalog::Weapon.find_or_create_by!(name: "Ancient Trident")    { |w| w.range = 2;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Aquatic", "Two-handed"] }
unarmed              = Catalog::Weapon.find_or_create_by!(name: "Unarmed")            { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 1;  w.abilities = [] }
barnacle_claymore    = Catalog::Weapon.find_or_create_by!(name: "Barnacle Claymore")  { |w| w.range = 1;  w.evasion = 1;  w.damage = 1;  w.penetration = -1; w.abilities = ["Two-handed", "Knockback"] }
ancient_claws        = Catalog::Weapon.find_or_create_by!(name: "Ancient Claws")      { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = -1; w.abilities = [] }
golden_tipped_claws  = Catalog::Weapon.find_or_create_by!(name: "Golden Tipped Claws"){ |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -2; w.abilities = [] }
voice_of_madness     = Catalog::Weapon.find_or_create_by!(name: "Voice of Madness")   { |w| w.range = 0;  w.evasion = -1; w.damage = 0;  w.penetration = -3; w.abilities = ["Stun", "Template"] }
colossal_jaws        = Catalog::Weapon.find_or_create_by!(name: "Colossal Jaws")      { |w| w.range = 2;  w.evasion = 2;  w.damage = 2;  w.penetration = -3; w.abilities = ["Aquatic"] }
eldritch_maw         = Catalog::Weapon.find_or_create_by!(name: "Eldritch Maw")       { |w| w.range = 1;  w.evasion = 0;  w.damage = 0;  w.penetration = -4; w.abilities = ["Aquatic"] }
fanged_maw           = Catalog::Weapon.find_or_create_by!(name: "Fanged Maw")         { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Stun"] }
lashing_swipe        = Catalog::Weapon.find_or_create_by!(name: "Lashing Swipe")      { |w| w.range = 0;  w.evasion = -1; w.damage = 0;  w.penetration = -1; w.abilities = [] }
rending_spine        = Catalog::Weapon.find_or_create_by!(name: "Rending Spine")      { |w| w.range = 6;  w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = ["Knockback"] }
thorned_grasp        = Catalog::Weapon.find_or_create_by!(name: "Thorned Grasp")      { |w| w.range = 2;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Stun"] }
staff                = Catalog::Weapon.find_or_create_by!(name: "Staff")              { |w| w.range = 1;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
crushing_claws       = Catalog::Weapon.find_or_create_by!(name: "Crushing Claws")     { |w| w.range = 0;  w.evasion = 2;  w.damage = 3;  w.penetration = 0;  w.abilities = ["Aquatic"] }
mauling_talons       = Catalog::Weapon.find_or_create_by!(name: "Mauling Talons")     { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Aquatic"] }
iron_mace            = Catalog::Weapon.find_or_create_by!(name: "Iron Mace")          { |w| w.range = 1;  w.evasion = 1;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Stun"] }
sacrificial_dagger   = Catalog::Weapon.find_or_create_by!(name: "Sacrificial Dagger") { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = [] }
burning_brand        = Catalog::Weapon.find_or_create_by!(name: "Burning Brand")      { |w| w.range = 2;  w.evasion = 0;  w.damage = 0;  w.penetration = -3; w.abilities = ["Smoke", "Two-handed"] }
herding_spear        = Catalog::Weapon.find_or_create_by!(name: "Herding Spear")      { |w| w.range = 2;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Knockback", "Two-handed"] }
mighty_jaws          = Catalog::Weapon.find_or_create_by!(name: "Mighty Jaws")        { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -3; w.abilities = ["Aquatic"] }
barbed_tentacles     = Catalog::Weapon.find_or_create_by!(name: "Barbed Tentacles")   { |w| w.range = 2;  w.evasion = 0;  w.damage = -1; w.penetration = -2; w.abilities = ["Aquatic", "Stun"] }
...
claws                = Catalog::Weapon.find_or_create_by!(name: "Claws", damage: 0)    { |w| w.range = 0;  w.evasion = 0;  w.penetration = -1; w.abilities = ["Aquatic"] }
webbed_fists         = Catalog::Weapon.find_or_create_by!(name: "Webbed Fists")       { |w| w.range = 0;  w.evasion = 0;  w.damage = 2;  w.penetration = 0;  w.abilities = [] }

# ── Leaders ───────────────────────────────────────────────────────────────────

flame_that_burns = Catalog::Profile.find_or_create_by!(name: "The Flame That Burns Underwater") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: flame_that_burns, weapon: brawling_tentacles_w) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: flame_that_burns, weapon: ornate_trident)       { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: flame_that_burns, special_rule: hydras_gifts)          { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: flame_that_burns, special_rule: dragging_down)         { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: flame_that_burns, special_rule: brawling_tentacles_sr) { |psr| psr.position = 2 }

magi_rashaar = Catalog::Profile.find_or_create_by!(name: "Magi-Rashaar") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: magi_rashaar, weapon: ancient_trident) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: magi_rashaar, special_rule: fury_of_dagon) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: magi_rashaar, special_rule: rent_born)     { |psr| psr.position = 1 }

paartul_matriarch = Catalog::Profile.find_or_create_by!(name: "Paartul Matriarch") do |p|
  p.version = "2.2.1"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: paartul_matriarch, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: paartul_matriarch, special_rule: birth)      { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: paartul_matriarch, special_rule: matriarch)  { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: paartul_matriarch, special_rule: postpartum) { |psr| psr.position = 2 }

sir_tiburcio = Catalog::Profile.find_or_create_by!(name: "Sir Tiburcio") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: sir_tiburcio, weapon: barnacle_claymore) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: sir_tiburcio, special_rule: shield_to_the_enlightened) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: sir_tiburcio, special_rule: vatican_apostate)          { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: sir_tiburcio, special_rule: dead_weight)               { |psr| psr.position = 2 }

thalidraur = Catalog::Profile.find_or_create_by!(name: "Thalidraur") do |p|
  p.version = "2.2.1"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: thalidraur, weapon: ancient_claws) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: thalidraur, special_rule: hide_of_the_deep)   { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: thalidraur, special_rule: foetid_pheromones)  { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: thalidraur, special_rule: lead_through_fear)  { |psr| psr.position = 2 }

voice_of_dagon = Catalog::Profile.find_or_create_by!(name: "Voice of Dagon") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: voice_of_dagon, weapon: golden_tipped_claws) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: voice_of_dagon, weapon: voice_of_madness)    { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: voice_of_dagon, special_rule: blessing_of_dagon)    { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: voice_of_dagon, special_rule: herald_of_an_old_god) { |psr| psr.position = 1 }

# ── Heroes ────────────────────────────────────────────────────────────────────

morgraur = Catalog::Profile.find_or_create_by!(name: "Morgraur") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: morgraur, weapon: colossal_jaws) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: morgraur, special_rule: serpentine)    { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: morgraur, special_rule: swallow_whole) { |psr| psr.position = 1 }

emissary_of_mother_hydra = Catalog::Profile.find_or_create_by!(name: "Emissary of Mother Hydra") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: emissary_of_mother_hydra, weapon: eldritch_maw) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: emissary_of_mother_hydra, special_rule: grasp_of_the_abyss) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: emissary_of_mother_hydra, special_rule: rip_apart)          { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: emissary_of_mother_hydra, special_rule: serpentine)         { |psr| psr.position = 2 }

# ── Henchmen — Emissary's Tentacles ─────────────────────────────────────────────

maw_tentacle = Catalog::Profile.find_or_create_by!(name: "Maw Tentacle") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: maw_tentacle, weapon: fanged_maw) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: maw_tentacle, special_rule: part_of_the_whole) { |psr| psr.position = 0 }

lash_tentacle = Catalog::Profile.find_or_create_by!(name: "Lash Tentacle") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
  p.action_points = 2; p.life_points = 5; p.will_points = 1; p.command_points = 0
  p.size = 30; p.ducats = 0; p.movement = 2; p.dexterity = 4; p.attack = 3; p.protection = 1; p.mind = 1
  p.keywords = ["Henchman"]
...
Catalog::ProfileWeapon.find_or_create_by!(profile: lash_tentacle, weapon: lashing_swipe) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: lash_tentacle, special_rule: part_of_the_whole) { |psr| psr.position = 0 }

dagger_tentacle = Catalog::Profile.find_or_create_by!(name: "Dagger Tentacle") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
  p.action_points = 2; p.life_points = 5; p.will_points = 1; p.command_points = 0
  p.size = 30; p.ducats = 0; p.movement = 2; p.dexterity = 4; p.attack = 3; p.protection = 1; p.mind = 1
  p.keywords = ["Henchman"]
...
Catalog::ProfileWeapon.find_or_create_by!(profile: dagger_tentacle, weapon: rending_spine) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: dagger_tentacle, special_rule: part_of_the_whole) { |psr| psr.position = 0 }

thorn_tentacle = Catalog::Profile.find_or_create_by!(name: "Thorn Tentacle") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
  p.action_points = 2; p.life_points = 5; p.will_points = 1; p.command_points = 0
  p.size = 30; p.ducats = 0; p.movement = 2; p.dexterity = 4; p.attack = 3; p.protection = 1; p.mind = 1
  p.keywords = ["Henchman"]
...
Catalog::ProfileWeapon.find_or_create_by!(profile: thorn_tentacle, weapon: thorned_grasp) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: thorn_tentacle, special_rule: part_of_the_whole) { |psr| psr.position = 0 }

# ── Heroes (continued) ──────────────────────────────────────────────────────────

drowned_nun = Catalog::Profile.find_or_create_by!(name: "The Drowned Nun") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileSpecialRule.find_or_create_by!(profile: drowned_nun, special_rule: fanaticism_for_dagon) { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: drowned_nun, special_rule: truth_of_dagon)       { |psr| psr.position = 2 }

brachyura = Catalog::Profile.find_or_create_by!(name: "Brachyura") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: brachyura, weapon: crushing_claws) { |pw| pw.position = 0 }

caandru_eel = Catalog::Profile.find_or_create_by!(name: "Caandru Eel") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: caandru_eel, weapon: mauling_talons) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: caandru_eel, special_rule: patient_hunter) { |psr| psr.position = 0 }

cult_enforcer = Catalog::Profile.find_or_create_by!(name: "Cult Enforcer") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: cult_enforcer, weapon: iron_mace) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: cult_enforcer, special_rule: bolster_your_faith) { |psr| psr.position = 0 }

dagonite_priest = Catalog::Profile.find_or_create_by!(name: "Dagonite Priest") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: dagonite_priest, weapon: sacrificial_dagger) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: dagonite_priest, special_rule: sacrifice) { |psr| psr.position = 0 }

demagogue = Catalog::Profile.find_or_create_by!(name: "Demagogue") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: demagogue, weapon: burning_brand) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: demagogue, special_rule: prove_yourselves_to_dagon) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: demagogue, special_rule: eldritch_incense)          { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: demagogue, special_rule: burned_flesh)              { |psr| psr.position = 2 }

handler = Catalog::Profile.find_or_create_by!(name: "Handler") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: handler, weapon: herding_spear) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: handler, special_rule: herding)                { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: handler, special_rule: encouragement_handler)  { |psr| psr.position = 1 }

karcharos = Catalog::Profile.find_or_create_by!(name: "Karcharos") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: karcharos, weapon: mighty_jaws) { |pw| pw.position = 0 }

krakenhost = Catalog::Profile.find_or_create_by!(name: "Krakenhost") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: krakenhost, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: krakenhost, special_rule: spawn_3lp)     { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: krakenhost, special_rule: living_vessel) { |psr| psr.position = 1 }

mature_kraken = Catalog::Profile.find_or_create_by!(name: "Mature Kraken") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: mature_kraken, weapon: barbed_tentacles) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: mature_kraken, special_rule: climbing_suckers) { |psr| psr.position = 0 }

paliaa = Catalog::Profile.find_or_create_by!(name: "Paliaa") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: paliaa, weapon: claws) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: paliaa, special_rule: gift_of_the_elder_gods) { |psr| psr.position = 0 }

raadru = Catalog::Profile.find_or_create_by!(name: "Raadru") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: raadru, weapon: webbed_fists) { |pw| pw.position = 0 }

# ── Special Rules (second half) ─────────────────────────────────────────────────

dimensional_pool = Catalog::SpecialRule.find_or_create_by!(name: "Dimensional Pool") do |r|
...
gusher = Catalog::SpecialRule.find_or_create_by!(name: "Gusher") do |r|
...
mucus = Catalog::SpecialRule.find_or_create_by!(name: "Mucus") do |r|
...
hypnotic_song = Catalog::SpecialRule.find_or_create_by!(name: "Hypnotic Song") do |r|
...
drag_to_the_depths = Catalog::SpecialRule.find_or_create_by!(name: "Drag to the Depths") do |r|
...
piercing_wail = Catalog::SpecialRule.find_or_create_by!(name: "Piercing Wail") do |r|
  r.description = "Any enemy characters within 6\" of this character have -1 DEXTERITY."
end
unsightly = Catalog::SpecialRule.find_or_create_by!(name: "Unsightly") do |r|
...
corrupted_relic = Catalog::SpecialRule.find_or_create_by!(name: "Corrupted Relic") do |r|
...
climber = Catalog::SpecialRule.find_or_create_by!(name: "Climber") do |r|
  r.description = "This character always counts as rolling at least one Ace when making Climb rolls."
end
one_mind = Catalog::SpecialRule.find_or_create_by!(name: "One Mind") do |r|
...
writhe_inside = Catalog::SpecialRule.find_or_create_by!(name: "Writhe Inside") do |r|
...
unassuming = Catalog::SpecialRule.find_or_create_by!(name: "Unassuming") do |r|
...
surrogate = Catalog::SpecialRule.find_or_create_by!(name: "Surrogate") do |r|
...
kraken_nurse = Catalog::SpecialRule.find_or_create_by!(name: "Kraken Nurse") do |r|
...
feast_for_dagon = Catalog::SpecialRule.find_or_create_by!(name: "Feast for Dagon") do |r|
...
water_portal        = Catalog::Weapon.find_or_create_by!(name: "Water Portal")        { |w| w.range = 6;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Aquatic", "Blast", "Reload (1)", "Stun"] }
sticky_burst        = Catalog::Weapon.find_or_create_by!(name: "Sticky Burst")        { |w| w.range = 6;  w.evasion = 2;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Stun", "Reload (2)"] }
grasping_jaws       = Catalog::Weapon.find_or_create_by!(name: "Grasping Jaws")       { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -2; w.abilities = [] }
razor_maw           = Catalog::Weapon.find_or_create_by!(name: "Razor Maw")           { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = -2; w.abilities = ["Aquatic"] }
mutated_limbs       = Catalog::Weapon.find_or_create_by!(name: "Mutated Limbs")       { |w| w.range = 4;  w.evasion = 1;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Aquatic"] }
weak_claws          = Catalog::Weapon.find_or_create_by!(name: "Weak Claws")          { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Aquatic"] }
tongue_harpoon      = Catalog::Weapon.find_or_create_by!(name: "Tongue Harpoon")      { |w| w.range = 12; w.evasion = 1;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Aquatic", "Knockback", "Reload (1)"] }
crusted_fist        = Catalog::Weapon.find_or_create_by!(name: "Crusted Fist")        { |w| w.range = 2;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Knockback", "Stun"] }
khopesh_daggers     = Catalog::Weapon.find_or_create_by!(name: "Khopesh Daggers")     { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = [] }
encrusted_hands     = Catalog::Weapon.find_or_create_by!(name: "Encrusted Hands")     { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
wave_blade_knife    = Catalog::Weapon.find_or_create_by!(name: "Wave-blade Knife")    { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = [] }
sodden_longsword    = Catalog::Weapon.find_or_create_by!(name: "Sodden Longsword")    { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = -1; w.abilities = ["Two-handed"] }
heavy_tentacles     = Catalog::Weapon.find_or_create_by!(name: "Heavy Tentacles")     { |w| w.range = 1;  w.evasion = 1;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Knockback"] }
gaping_maw          = Catalog::Weapon.find_or_create_by!(name: "Gaping Maw")          { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = [] }
encrusted_weapon    = Catalog::Weapon.find_or_create_by!(name: "Encrusted Weapon")    { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Aquatic"] }
dementing_tentacles = Catalog::Weapon.find_or_create_by!(name: "Dementing Tentacles") { |w| w.range = 0;  w.evasion = -1; w.damage = 0;  w.penetration = 0;  w.abilities = ["Aquatic", "Stun"] }
claws_ugdru         = Catalog::Weapon.find_or_create_by!(name: "Claws", damage: 1)    { |w| w.range = 0;  w.evasion = 0;  w.penetration = -1; w.abilities = ["Aquatic"] }
flint_dagger        = Catalog::Weapon.find_or_create_by!(name: "Flint Dagger")        { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }

# ── Heroes (second half) ──────────────────────────────────────────────────────

salaacia = Catalog::Profile.find_or_create_by!(name: "Salaacia") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: salaacia, weapon: water_portal) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: salaacia, special_rule: dimensional_pool) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: salaacia, special_rule: gusher)           { |psr| psr.position = 1 }

secreting_myxin = Catalog::Profile.find_or_create_by!(name: "Secreting Myxin") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: secreting_myxin, weapon: sticky_burst)  { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: secreting_myxin, weapon: grasping_jaws) { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: secreting_myxin, special_rule: mucus) { |psr| psr.position = 0 }

sirena = Catalog::Profile.find_or_create_by!(name: "Sirena") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: sirena, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: sirena, special_rule: hypnotic_song) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: sirena, special_rule: dragging_down) { |psr| psr.position = 1 }

tainted_maw = Catalog::Profile.find_or_create_by!(name: "Tainted Maw") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: tainted_maw, weapon: razor_maw)     { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: tainted_maw, weapon: mutated_limbs) { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: tainted_maw, special_rule: drag_to_the_depths) { |psr| psr.position = 0 }

# ── Henchmen (second half) ──────────────────────────────────────────────────────

advanced_hybrid = Catalog::Profile.find_or_create_by!(name: "Advanced Hybrid") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: advanced_hybrid, weapon: weak_claws) { |pw| pw.position = 0 }

aglaope = Catalog::Profile.find_or_create_by!(name: "Aglaope") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: bounding_telebine, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: bounding_telebine, special_rule: leaper) { |psr| psr.position = 0 }

bulbous_toad = Catalog::Profile.find_or_create_by!(name: "Bulbous Toad") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: bulbous_toad, weapon: tongue_harpoon) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: bulbous_toad, special_rule: barbed_tongue) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: bulbous_toad, special_rule: feeder)        { |psr| psr.position = 1 }
...
Catalog::ProfileWeapon.find_or_create_by!(profile: crybaby, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: crybaby, special_rule: bait)          { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: crybaby, special_rule: piercing_wail) { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: crybaby, special_rule: unsightly)     { |psr| psr.position = 2 }

cymothoan_crusher = Catalog::Profile.find_or_create_by!(name: "Cymothoan Crusher") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: cymothoan_crusher, weapon: crusted_fist) { |pw| pw.position = 0 }
...
Catalog::ProfileWeapon.find_or_create_by!(profile: dagon_officiant, weapon: khopesh_daggers) { |pw| pw.position = 0 }

dagonite_page = Catalog::Profile.find_or_create_by!(name: "Dagonite Page") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
  p.action_points = 2; p.life_points = 10; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: dagonite_page, weapon: encrusted_hands) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: dagonite_page, special_rule: corrupted_relic) { |psr| psr.position = 0 }
...
Catalog::ProfileWeapon.find_or_create_by!(profile: dagonite_zealot, weapon: wave_blade_knife) { |pw| pw.position = 0 }

encrusted_squire = Catalog::Profile.find_or_create_by!(name: "Encrusted Squire") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: encrusted_squire, weapon: sodden_longsword) { |pw| pw.position = 0 }

half_breed = Catalog::Profile.find_or_create_by!(name: "Half-Breed") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: half_breed, weapon: heavy_tentacles) { |pw| pw.position = 0 }

hellhound = Catalog::Profile.find_or_create_by!(name: "Hellhound") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
  p.action_points = 2; p.life_points = 10; p.will_points = 1; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: hellhound, weapon: gaping_maw) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: hellhound, special_rule: climber) { |psr| psr.position = 0 }

hybrid = Catalog::Profile.find_or_create_by!(name: "Hybrid") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
  p.action_points = 2; p.life_points = 11; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: hybrid, weapon: encrusted_weapon) { |pw| pw.position = 0 }
...
Catalog::ProfileWeapon.find_or_create_by!(profile: infant_kraken, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: infant_kraken, special_rule: one_mind)      { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: infant_kraken, special_rule: writhe_inside) { |psr| psr.position = 1 }

lesser_rhyll = Catalog::Profile.find_or_create_by!(name: "Lesser Rhyll") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: lesser_rhyll, weapon: dementing_tentacles) { |pw| pw.position = 0 }

lesser_ugdru = Catalog::Profile.find_or_create_by!(name: "Lesser Ugdru") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: lesser_ugdru, weapon: claws_ugdru) { |pw| pw.position = 0 }
...
Catalog::ProfileWeapon.find_or_create_by!(profile: slave, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: slave, special_rule: feast_for_dagon) { |psr| psr.position = 0 }

urchin = Catalog::Profile.find_or_create_by!(name: "Urchin") do |p|
  p.version = "2.2.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: urchin, weapon: flint_dagger) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: urchin, special_rule: unassuming) { |psr| psr.position = 0 }

wet_nurse = Catalog::Profile.find_or_create_by!(name: "Wet Nurse") do |p|
  p.version = "2.3.0"; p.faction = "rashaar"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: wet_nurse, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: wet_nurse, special_rule: surrogate)    { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: wet_nurse, special_rule: kraken_nurse) { |psr| psr.position = 1 }
...
# Pages 15, 30, 34, 36, 38, 42, 43, 45, 46, 47 produced _a/_b variants; _a is used.
{
  ...
  profile = Catalog::Profile.find_by(faction: "rashaar", name: name)
  next unless profile
...
# ── Card References ────────────────────────────────────────────────────────────
profile_map = Catalog::Profile.where(faction: "rashaar").each_with_object({}) { |p, h| h[p.name] = p.id }
now = Time.current
...
p_count  = Catalog::Profile.where(faction: "rashaar").count
