...
start_the_horrorshow = Catalog::SpecialRule.find_or_create_by!(name: "Start the Horrorshow!") do |r|
...
do_as_i_say = Catalog::SpecialRule.find_or_create_by!(name: "Do As I Say, Not As I Do") do |r|
...
fight_for_the_guild = Catalog::SpecialRule.find_or_create_by!(name: "Fight For the Guild!") do |r|
...
rise_up = Catalog::SpecialRule.find_or_create_by!(name: "Rise Up") do |r|
...
toughen_up = Catalog::SpecialRule.find_or_create_by!(name: "Toughen Up") do |r|
  r.description = "AURA Command Ability. Until the end of the round, any friendly characters within 6\" gain Expert Protection (3)."
end
born_to_swim = Catalog::SpecialRule.find_or_create_by!(name: "Born to Swim") do |r|
...
dont_let_them_take_you = Catalog::SpecialRule.find_or_create_by!(name: "Don't Let Them Take You!") do |r|
...
strike_when_vulnerable = Catalog::SpecialRule.find_or_create_by!(name: "Strike When They're Vulnerable") do |r|
...
my_girls_and_boys = Catalog::SpecialRule.find_or_create_by!(name: "My Girls & Boys") do |r|
...
full_tilt = Catalog::SpecialRule.find_or_create_by!(name: "Full Tilt!") do |r|
...
thieves_guild_training = Catalog::SpecialRule.find_or_create_by!(name: "Thieves Guild Training") do |r|
  r.description = "PULSE Command Ability. One friendly character within 6\" gains Pickpocket until the end of the game."
end
take_it_for_the_guild = Catalog::SpecialRule.find_or_create_by!(name: "Take it for the Guild!") do |r|
  r.description = "Any friendly characters in line of sight replenish 2 Will Points instead of 1 when Pickpocketing."
end
a_hero_among_thieves = Catalog::SpecialRule.find_or_create_by!(name: "A Hero Among Thieves") do |r|
...
blood_rights = Catalog::SpecialRule.find_or_create_by!(name: "Blood Rights") do |r|
...
rally_to_the_light = Catalog::SpecialRule.find_or_create_by!(name: "Rally to the Light!") do |r|
...
the_lamp = Catalog::SpecialRule.find_or_create_by!(name: "The Lamp") do |r|
...
hearty_fish_soup = Catalog::SpecialRule.find_or_create_by!(name: "Hearty Fish Soup") do |r|
...
a_choice_cut = Catalog::SpecialRule.find_or_create_by!(name: "A Choice Cut") do |r|
  r.description = "When this character kills a character with the Monster keyword, it replenishes 1CP."
end
gifts_of_dried_meats = Catalog::SpecialRule.find_or_create_by!(name: "Gifts of Dried Meats") do |r|
...
uncoordinated_assault = Catalog::SpecialRule.find_or_create_by!(name: "Uncoordinated Assault") do |r|
...
levatesi_di_mezzo = Catalog::SpecialRule.find_or_create_by!(name: "Levatesi di Mezzo, Imbecilli!") do |r|
...
magic_for_blood = Catalog::SpecialRule.find_or_create_by!(name: "Magic for Blood") do |r|
...
blood_for_magic = Catalog::SpecialRule.find_or_create_by!(name: "Blood for Magic") do |r|
...
go_for_the_eyes = Catalog::SpecialRule.find_or_create_by!(name: "Go For the Eyes") do |r|
...
prey_upon = Catalog::SpecialRule.find_or_create_by!(name: "Prey Upon") do |r|
...
intimidation = Catalog::SpecialRule.find_or_create_by!(name: "Intimidation") do |r|
  r.description = "AURA Command Ability. Until the end of the round, any friendly characters within 3\" gain First Strike (1)."
end
twin_pistols = Catalog::SpecialRule.find_or_create_by!(name: "Twin Pistols") do |r|
...
unwieldy = Catalog::SpecialRule.find_or_create_by!(name: "Unwieldy") do |r|
...
fancy_a_tipple = Catalog::SpecialRule.find_or_create_by!(name: "Fancy a Tipple?") do |r|
...
keep_it_flowing = Catalog::SpecialRule.find_or_create_by!(name: "Keep it Flowing") do |r|
...
flambe = Catalog::SpecialRule.find_or_create_by!(name: "Flambé") do |r|
  r.description = "This character may only use Flaming Bottles when within 3\" of a Pulcinella Firebreather."
end
thick_skull = Catalog::SpecialRule.find_or_create_by!(name: "Thick Skull") do |r|
  r.description = "This character cannot receive Stunned counters."
end
communicative_dance = Catalog::SpecialRule.find_or_create_by!(name: "Communicative Dance") do |r|
...
victory_rush = Catalog::SpecialRule.find_or_create_by!(name: "Victory Rush") do |r|
...
bring_it_down = Catalog::SpecialRule.find_or_create_by!(name: "Bring it Down!") do |r|
  r.description = "PULSE Command Ability. One friendly character within 6\" gains Hunter until the end of the game."
end
extortion = Catalog::SpecialRule.find_or_create_by!(name: "Extortion") do |r|
...
instigator = Catalog::SpecialRule.find_or_create_by!(name: "Instigator") do |r|
...
entwined_magics = Catalog::SpecialRule.find_or_create_by!(name: "Entwined Magics") do |r|
...
fade_to_the_shadow = Catalog::SpecialRule.find_or_create_by!(name: "Fade to the Shadow") do |r|
...
smuggling = Catalog::SpecialRule.find_or_create_by!(name: "Smuggling") do |r|
  r.description = "When you achieve an Agenda, one character within 6\" and line of sight replenishes 1 Command Point."
end
get_to_the_roof = Catalog::SpecialRule.find_or_create_by!(name: "Get to the Roof") do |r|
...
toot_toot_charge = Catalog::SpecialRule.find_or_create_by!(name: "Toot Toot Toot... Charge!") do |r|
...
doot = Catalog::SpecialRule.find_or_create_by!(name: "Doot") do |r|
...
get_over_here = Catalog::SpecialRule.find_or_create_by!(name: "Get Over Here") do |r|
  r.description = "A Whaling Lance's Knockback can move the target in any direction."
end
whispers_on_the_street = Catalog::SpecialRule.find_or_create_by!(name: "Whispers on the Street") do |r|
...
hidden_in_plain_sight = Catalog::SpecialRule.find_or_create_by!(name: "Hidden in Plain Sight") do |r|
...
living_sacrifice = Catalog::SpecialRule.find_or_create_by!(name: "Living Sacrifice") do |r|
...
transfusion = Catalog::SpecialRule.find_or_create_by!(name: "Transfusion") do |r|
...
bucket_of_blood = Catalog::SpecialRule.find_or_create_by!(name: "Bucket of Blood") do |r|
...
encouragement = Catalog::SpecialRule.find_or_create_by!(name: '"Encouragement"') do |r|
  r.description = "This character may only use the ORDER or COUNTER Commands on characters with the Henchman keyword."
end
sculler = Catalog::SpecialRule.find_or_create_by!(name: "Sculler") do |r|
...
paying_off_my_debts = Catalog::SpecialRule.find_or_create_by!(name: "Paying Off My Debts") do |r|
  r.description = "When this character kills an enemy character with a Combat action, add 1 re-roll to your Mob Mentality pool."
end
rope_arrow = Catalog::SpecialRule.find_or_create_by!(name: "Rope Arrow") do |r|
...
staff_of_credit       = Catalog::Weapon.find_or_create_by!(name: "Staff of Credit")       { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -3; w.abilities = [] }
twin_blades           = Catalog::Weapon.find_or_create_by!(name: "Twin Blades")           { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = [] }
clockwork_pistol      = Catalog::Weapon.find_or_create_by!(name: "Clockwork Pistol")      { |w| w.range = 6;  w.evasion = 1;  w.damage = 1;  w.penetration = -1; w.abilities = ["Black Powder", "Reload (2)"] }
sailors_knife         = Catalog::Weapon.find_or_create_by!(name: "Sailor's Knife")        { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = ["Aquatic"] }
garter_pistol         = Catalog::Weapon.find_or_create_by!(name: "Garter Pistol")         { |w| w.range = 6;  w.evasion = 0;  w.damage = 0;  w.penetration = -2; w.abilities = ["Black Powder", "Reload (2)"] }
stiletto              = Catalog::Weapon.find_or_create_by!(name: "Stiletto")              { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = 1;  w.abilities = [] }
concealed_pistol      = Catalog::Weapon.find_or_create_by!(name: "Concealed Pistol")      { |w| w.range = 4;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Black Powder", "Reload (1)", "Knockback"] }
gilded_sword          = Catalog::Weapon.find_or_create_by!(name: "Gilded Sword")          { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = -1; w.abilities = [] }
pestle                = Catalog::Weapon.find_or_create_by!(name: "Pestle")                { |w| w.range = 1;  w.evasion = 0;  w.damage = 2;  w.penetration = 0;  w.abilities = ["Knockback", "Two-handed"] }
...
fishmongers_knives    = Catalog::Weapon.find_or_create_by!(name: "Fishmonger's Knives")   { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = -1; w.abilities = [] }
thrown_harpoon        = Catalog::Weapon.find_or_create_by!(name: "Thrown Harpoon")        { |w| w.range = 4;  w.evasion = 1;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Reload (1)"] }
club                  = Catalog::Weapon.find_or_create_by!(name: "Club")                  { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Stun"] }
bottle_burner         = Catalog::Weapon.find_or_create_by!(name: "Bottle Burner")         { |w| w.range = 5;  w.evasion = 2;  w.damage = 1;  w.penetration = -1; w.abilities = ["Black Powder", "Blast"] }
bird_kick             = Catalog::Weapon.find_or_create_by!(name: "Bird Kick")             { |w| w.range = 0;  w.evasion = 0;  w.damage = 2;  w.penetration = 0;  w.abilities = [] }
balanced_knife        = Catalog::Weapon.find_or_create_by!(name: "Balanced Throwing Knife") { |w| w.range = 6; w.evasion = 0; w.damage = -1; w.penetration = -4; w.abilities = [] }
...
dagger                = Catalog::Weapon.find_or_create_by!(name: "Dagger")                { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
pithing_needle        = Catalog::Weapon.find_or_create_by!(name: "Pithing Needle")        { |w| w.range = 0;  w.evasion = 1;  w.damage = 0;  w.penetration = -1; w.abilities = ["Stun"] }
straight_razor        = Catalog::Weapon.find_or_create_by!(name: "Straight Razor")        { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -3; w.abilities = [] }
duelling_pistol       = Catalog::Weapon.find_or_create_by!(name: "Duelling Pistol")       { |w| w.range = 8;  w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = ["Black Powder", "Reload (2)"] }
twin_duelling_pistols = Catalog::Weapon.find_or_create_by!(name: "Twin Duelling Pistols") { |w| w.range = 8;  w.evasion = 0;  w.damage = 3;  w.penetration = -1; w.abilities = ["Black Powder", "Reload (1)"] }
bottles               = Catalog::Weapon.find_or_create_by!(name: "Bottles")               { |w| w.range = 6;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
flaming_bottles       = Catalog::Weapon.find_or_create_by!(name: "Flaming Bottles")       { |w| w.range = 6;  w.evasion = 0;  w.damage = 0;  w.penetration = -5; w.abilities = ["Black Powder"] }
big_club              = Catalog::Weapon.find_or_create_by!(name: "Big Club")              { |w| w.range = 1;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Knockback"] }
butchers_knives       = Catalog::Weapon.find_or_create_by!(name: "Butcher's Knives")      { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = [] }
poisoned_needle       = Catalog::Weapon.find_or_create_by!(name: "Poisoned Needle")       { |w| w.range = 0;  w.evasion = -1; w.damage = 0;  w.penetration = 1;  w.abilities = ["Poisoned"] }
rapier                = Catalog::Weapon.find_or_create_by!(name: "Rapier")                { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = [] }
pole_spear_and_net    = Catalog::Weapon.find_or_create_by!(name: "Pole Spear & Net")      { |w| w.range = 0;  w.evasion = -1; w.damage = 1;  w.penetration = 0;  w.abilities = ["Aquatic"] }
harpoon_gun           = Catalog::Weapon.find_or_create_by!(name: "Harpoon Gun")           { |w| w.range = 12; w.evasion = 1;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Reload (1)", "Two-handed"] }
...
dual_stilettos        = Catalog::Weapon.find_or_create_by!(name: "Dual Stilettos")        { |w| w.range = 0;  w.evasion = -1; w.damage = 1;  w.penetration = 1;  w.abilities = [] }
blunderbuss           = Catalog::Weapon.find_or_create_by!(name: "Blunderbuss")           { |w| w.range = 0;  w.evasion = -1; w.damage = 2;  w.penetration = 1;  w.abilities = ["Black Powder", "Reload (1)", "Template"] }
trumpet               = Catalog::Weapon.find_or_create_by!(name: "Trumpet")               { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
whaling_lance         = Catalog::Weapon.find_or_create_by!(name: "Whaling Lance")         { |w| w.range = 6;  w.evasion = 1;  w.damage = 3;  w.penetration = 0;  w.abilities = ["Knockback", "Two-handed"] }
crossbow              = Catalog::Weapon.find_or_create_by!(name: "Crossbow")              { |w| w.range = 30; w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = ["Reload (1)", "Two-handed"] }
improvised_weapon     = Catalog::Weapon.find_or_create_by!(name: "Improvised Weapon")     { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
training_whip         = Catalog::Weapon.find_or_create_by!(name: "Training Whip")         { |w| w.range = 3;  w.evasion = -1; w.damage = 0;  w.penetration = 0;  w.abilities = [] }
teeth                 = Catalog::Weapon.find_or_create_by!(name: "Teeth")                 { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = -1; w.abilities = [] }
sword                 = Catalog::Weapon.find_or_create_by!(name: "Sword")                 { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = [] }
fire_breath           = Catalog::Weapon.find_or_create_by!(name: "Fire Breath")           { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -3; w.abilities = ["Black Powder", "Template", "Two-handed", "Reload (1)"] }
bladed_oar            = Catalog::Weapon.find_or_create_by!(name: "Bladed Oar")            { |w| w.range = 2;  w.evasion = 0;  w.damage = 1;  w.penetration = -1; w.abilities = ["Two-handed"] }
short_bow             = Catalog::Weapon.find_or_create_by!(name: "Short Bow")             { |w| w.range = 12; w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Reload (3)", "Two-handed"] }
...
dive_knife            = Catalog::Weapon.find_or_create_by!(name: "Dive Knife")            { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Aquatic"] }
riveting_hammer       = Catalog::Weapon.find_or_create_by!(name: "Riveting Hammer")       { |w| w.range = 0;  w.evasion = 0;  w.damage = 2;  w.penetration = 0;  w.abilities = ["Two-handed"] }

# ── Leaders ───────────────────────────────────────────────────────────────────

capodecina = Catalog::Profile.find_or_create_by!(name: "Capodecina") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: capodecina, weapon: twin_blades) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: capodecina, special_rule: fight_for_the_guild) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: capodecina, special_rule: rise_up)             { |psr| psr.position = 1 }

harbourmaster = Catalog::Profile.find_or_create_by!(name: "Harbourmaster") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: harbourmaster, weapon: clockwork_pistol) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: harbourmaster, weapon: sailors_knife)    { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: harbourmaster, special_rule: toughen_up)   { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: harbourmaster, special_rule: born_to_swim) { |psr| psr.position = 1 }

king_for_a_day = Catalog::Profile.find_or_create_by!(name: "King For a Day") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: king_for_a_day, weapon: staff_of_credit) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: king_for_a_day, special_rule: start_the_horrorshow) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: king_for_a_day, special_rule: do_as_i_say)          { |psr| psr.position = 1 }

madame = Catalog::Profile.find_or_create_by!(name: "Madame") do |p|
  p.version = "2.3.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: madame, weapon: garter_pistol) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: madame, weapon: stiletto)       { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: madame, special_rule: dont_let_them_take_you)  { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: madame, special_rule: strike_when_vulnerable)  { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: madame, special_rule: my_girls_and_boys)       { |psr| psr.position = 2 }

ostrich_king = Catalog::Profile.find_or_create_by!(name: "Ostrich King?!") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: ostrich_king, weapon: staff_of_credit) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ostrich_king, special_rule: full_tilt)   { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ostrich_king, special_rule: do_as_i_say) { |psr| psr.position = 1 }

prince_of_thieves = Catalog::Profile.find_or_create_by!(name: "Prince of Thieves") do |p|
  p.version = "2.3.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: prince_of_thieves, weapon: concealed_pistol) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: prince_of_thieves, weapon: gilded_sword)     { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: prince_of_thieves, special_rule: thieves_guild_training) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: prince_of_thieves, special_rule: take_it_for_the_guild)  { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: prince_of_thieves, special_rule: a_hero_among_thieves)   { |psr| psr.position = 2 }

# ── Heroes ────────────────────────────────────────────────────────────────────

baba_yaga = Catalog::Profile.find_or_create_by!(name: "Baba-Yaga") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: baba_yaga, weapon: pestle) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: baba_yaga, special_rule: blood_rights) { |psr| psr.position = 0 }

barber = Catalog::Profile.find_or_create_by!(name: "Barber") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: barber, weapon: straight_razor) { |pw| pw.position = 0 }

baroni = Catalog::Profile.find_or_create_by!(name: "Baroni") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: baroni, weapon: duelling_pistol)       { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: baroni, weapon: twin_duelling_pistols) { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: baroni, special_rule: intimidation)  { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: baroni, special_rule: twin_pistols)  { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: baroni, special_rule: unwieldy)      { |psr| psr.position = 2 }

black_lamp = Catalog::Profile.find_or_create_by!(name: "Black Lamp") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: black_lamp, weapon: sharpened_dagger) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: black_lamp, special_rule: rally_to_the_light) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: black_lamp, special_rule: the_lamp)           { |psr| psr.position = 1 }

bloodletter = Catalog::Profile.find_or_create_by!(name: "Bloodletter") do |p|
  p.version = "2.2.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 11; p.will_points = 3; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: bloodletter, weapon: dagger) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: bloodletter, special_rule: magic_for_blood) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: bloodletter, special_rule: blood_for_magic) { |psr| psr.position = 1 }

blood_matron = Catalog::Profile.find_or_create_by!(name: "Blood Matron") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: blood_matron, weapon: pithing_needle) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: blood_matron, special_rule: go_for_the_eyes) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: blood_matron, special_rule: prey_upon)       { |psr| psr.position = 1 }

brewer = Catalog::Profile.find_or_create_by!(name: "Brewer") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: brewer, weapon: bottles)        { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: brewer, weapon: flaming_bottles) { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: brewer, special_rule: fancy_a_tipple)  { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: brewer, special_rule: keep_it_flowing) { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: brewer, special_rule: flambe)          { |psr| psr.position = 2 }

brute = Catalog::Profile.find_or_create_by!(name: "Brute") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: brute, weapon: big_club) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: brute, special_rule: thick_skull) { |psr| psr.position = 0 }
...
Catalog::ProfileWeapon.find_or_create_by!(profile: butcher, weapon: butchers_knives) { |pw| pw.position = 0 }

dancer = Catalog::Profile.find_or_create_by!(name: "Dancer") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: dancer, weapon: poisoned_needle) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: dancer, special_rule: communicative_dance) { |psr| psr.position = 0 }

death_duellist = Catalog::Profile.find_or_create_by!(name: "Death Duellist") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: death_duellist, weapon: rapier) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: death_duellist, special_rule: victory_rush) { |psr| psr.position = 0 }

ebenezer = Catalog::Profile.find_or_create_by!(name: "Ebenezer Chummage") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: ebenezer, weapon: fishmongers_knives) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: ebenezer, weapon: thrown_harpoon)     { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ebenezer, special_rule: hearty_fish_soup)    { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ebenezer, special_rule: a_choice_cut)        { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ebenezer, special_rule: gifts_of_dried_meats) { |psr| psr.position = 2 }

fisherman = Catalog::Profile.find_or_create_by!(name: "Fisherman") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: fisherman, weapon: pole_spear_and_net) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: fisherman, weapon: harpoon_gun)        { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: fisherman, special_rule: bring_it_down) { |psr| psr.position = 0 }

ostrich_chariot = Catalog::Profile.find_or_create_by!(name: "Ostrich Chariot?!") do |p|
  p.version = "2.2.1"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: ostrich_chariot, weapon: club)          { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: ostrich_chariot, weapon: bottle_burner) { |pw| pw.position = 1 }
Catalog::ProfileWeapon.find_or_create_by!(profile: ostrich_chariot, weapon: bird_kick)     { |pw| pw.position = 2 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ostrich_chariot, special_rule: uncoordinated_assault) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ostrich_chariot, special_rule: levatesi_di_mezzo)     { |psr| psr.position = 1 }

rialto_assassin = Catalog::Profile.find_or_create_by!(name: "Rialto Assassin") do |p|
  p.version = "2.2.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 13; p.will_points = 3; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: rialto_assassin, weapon: balanced_knife) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: rialto_assassin, weapon: smoke_bomb)     { |pw| pw.position = 1 }

recruiter = Catalog::Profile.find_or_create_by!(name: "Recruiter") do |p|
  p.version = "2.2.1"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: recruiter, weapon: handbow) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: recruiter, special_rule: extortion)  { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: recruiter, special_rule: instigator) { |psr| psr.position = 1 }

seamstress = Catalog::Profile.find_or_create_by!(name: "Seamstress") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: seamstress, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: seamstress, special_rule: entwined_magics) { |psr| psr.position = 0 }

shadow_assassin = Catalog::Profile.find_or_create_by!(name: "Shadow Assassin") do |p|
  p.version = "2.2.1"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: shadow_assassin, weapon: dual_stilettos) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: shadow_assassin, special_rule: fade_to_the_shadow) { |psr| psr.position = 0 }

smuggler = Catalog::Profile.find_or_create_by!(name: "Smuggler") do |p|
  p.version = "2.3.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: smuggler, weapon: blunderbuss) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: smuggler, special_rule: smuggling) { |psr| psr.position = 0 }

thief = Catalog::Profile.find_or_create_by!(name: "Thief") do |p|
  p.version = "2.2.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 11; p.will_points = 3; p.command_points = 1
...
Catalog::ProfileWeapon.find_or_create_by!(profile: thief, weapon: stiletto)   { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: thief, weapon: smoke_bomb) { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: thief, special_rule: get_to_the_roof) { |psr| psr.position = 0 }

very_loud_ostrich = Catalog::Profile.find_or_create_by!(name: "Very Loud Ostrich") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: very_loud_ostrich, weapon: trumpet) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: very_loud_ostrich, special_rule: toot_toot_charge) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: very_loud_ostrich, special_rule: doot)             { |psr| psr.position = 1 }

whaler = Catalog::Profile.find_or_create_by!(name: "Whaler") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: whaler, weapon: whaling_lance) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: whaler, special_rule: get_over_here) { |psr| psr.position = 0 }

witch = Catalog::Profile.find_or_create_by!(name: "Witch") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: witch, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: witch, special_rule: blood_rights) { |psr| psr.position = 0 }

# ── Henchmen ──────────────────────────────────────────────────────────────────

arbalest = Catalog::Profile.find_or_create_by!(name: "Arbalest") do |p|
  p.version = "2.3.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 10; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: arbalest, weapon: crossbow) { |pw| pw.position = 0 }
...
Catalog::ProfileWeapon.find_or_create_by!(profile: beggar, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: beggar, special_rule: whispers_on_the_street) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: beggar, special_rule: hidden_in_plain_sight)  { |psr| psr.position = 1 }

blooded = Catalog::Profile.find_or_create_by!(name: "Blooded") do |p|
  p.version = "2.3.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 10; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: blooded, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: blooded, special_rule: living_sacrifice) { |psr| psr.position = 0 }

blood_courier = Catalog::Profile.find_or_create_by!(name: "Blood Courier") do |p|
  p.version = "2.3.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 10; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: blood_courier, weapon: dagger) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: blood_courier, special_rule: transfusion)    { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: blood_courier, special_rule: bucket_of_blood) { |psr| psr.position = 1 }

citizen = Catalog::Profile.find_or_create_by!(name: "Citizen") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: citizen, weapon: improvised_weapon) { |pw| pw.position = 0 }

dog_keeper = Catalog::Profile.find_or_create_by!(name: "Dog Keeper") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: dog_keeper, weapon: training_whip) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: dog_keeper, special_rule: encouragement) { |psr| psr.position = 0 }

dog = Catalog::Profile.find_or_create_by!(name: "Dog") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: dog, weapon: teeth) { |pw| pw.position = 0 }

escort = Catalog::Profile.find_or_create_by!(name: "Escort") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: escort, weapon: sword) { |pw| pw.position = 0 }

firebreather = Catalog::Profile.find_or_create_by!(name: "Firebreather") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: firebreather, weapon: fire_breath) { |pw| pw.position = 0 }

gondolier = Catalog::Profile.find_or_create_by!(name: "Gondolier") do |p|
  p.version = "2.2.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 11; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: gondolier, weapon: bladed_oar) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: gondolier, special_rule: sculler) { |psr| psr.position = 0 }

harlot = Catalog::Profile.find_or_create_by!(name: "Harlot") do |p|
  p.version = "2.2.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 11; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: harlot, weapon: stiletto) { |pw| pw.position = 0 }

indebted = Catalog::Profile.find_or_create_by!(name: "Indebted") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: indebted, weapon: short_sword) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: indebted, special_rule: paying_off_my_debts) { |psr| psr.position = 0 }

mariner = Catalog::Profile.find_or_create_by!(name: "Mariner") do |p|
  p.version = "2.2.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 11; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: mariner, weapon: dive_knife) { |pw| pw.position = 0 }

ostrich_rider = Catalog::Profile.find_or_create_by!(name: "Ostrich Rider") do |p|
  p.version = "2.2.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 13; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: ostrich_rider, weapon: club) { |pw| pw.position = 0 }

pilferer = Catalog::Profile.find_or_create_by!(name: "Pilferer") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: pilferer, weapon: dagger) { |pw| pw.position = 0 }

poacher = Catalog::Profile.find_or_create_by!(name: "Poacher") do |p|
  p.version = "2.2.0"; p.faction = "guild"
  p.action_points = 2; p.life_points = 10; p.will_points = 2; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: poacher, weapon: short_bow) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: poacher, special_rule: rope_arrow) { |psr| psr.position = 0 }

pulcinella = Catalog::Profile.find_or_create_by!(name: "Pulcinella") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: pulcinella, weapon: club) { |pw| pw.position = 0 }

shipwright = Catalog::Profile.find_or_create_by!(name: "Shipwright") do |p|
  p.version = "2.2.0"; p.faction = "guild"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: shipwright, weapon: riveting_hammer) { |pw| pw.position = 0 }
...
# Pages 31-33, 35, 37, 40-43, 45-47 produced _a/_b variants; _a is used as primary.
{
  ...
  profile = Catalog::Profile.find_by(faction: "guild", name: name)
  next unless profile
...
# ── Card References ────────────────────────────────────────────────────────────
profile_map = Catalog::Profile.where(faction: "guild").each_with_object({}) { |p, h| h[p.name] = p.id }
now = Time.current
...
p_count  = Catalog::Profile.where(faction: "guild").count
