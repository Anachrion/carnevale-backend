...
transformation = Catalog::SpecialRule.find_or_create_by!(name: "Transformation") do |r|
...
master_bloodline = Catalog::SpecialRule.find_or_create_by!(name: "Master Bloodline") do |r|
...
connoisseur = Catalog::SpecialRule.find_or_create_by!(name: "Connoisseur") do |r|
...
clairvoyancy = Catalog::SpecialRule.find_or_create_by!(name: "Clairvoyancy") do |r|
...
major_arcana = Catalog::SpecialRule.find_or_create_by!(name: "Major Arcana") do |r|
...
minor_incantata = Catalog::SpecialRule.find_or_create_by!(name: "Minor Incantata") do |r|
...
blood_frenzy = Catalog::SpecialRule.find_or_create_by!(name: "Blood Frenzy") do |r|
...
bloodline = Catalog::SpecialRule.find_or_create_by!(name: "Bloodline") do |r|
...
sanguine_sabotage = Catalog::SpecialRule.find_or_create_by!(name: "Sanguine Sabotage") do |r|
...
natural_camouflage = Catalog::SpecialRule.find_or_create_by!(name: "Natural Camouflage") do |r|
...
carrion = Catalog::SpecialRule.find_or_create_by!(name: "Carrion") do |r|
  r.description = "Before deployment, choose 3 friendly characters. They gain Infiltration."
end
defensive_lines = Catalog::SpecialRule.find_or_create_by!(name: "Defensive Lines") do |r|
...
warlord = Catalog::SpecialRule.find_or_create_by!(name: "Warlord") do |r|
...
procession_of_brides = Catalog::SpecialRule.find_or_create_by!(name: "Procession of Brides") do |r|
...
romani_fury = Catalog::SpecialRule.find_or_create_by!(name: "Romani Fury") do |r|
...
african_bewitching = Catalog::SpecialRule.find_or_create_by!(name: "African Bewitching") do |r|
...
eastern_swiftness = Catalog::SpecialRule.find_or_create_by!(name: "Eastern Swiftness") do |r|
...
sisters_of_gelo = Catalog::SpecialRule.find_or_create_by!(name: "Sisters of Gélo") do |r|
...
aerial_aggression = Catalog::SpecialRule.find_or_create_by!(name: "Aerial Aggression") do |r|
...
rip_and_tear = Catalog::SpecialRule.find_or_create_by!(name: "Rip and Tear") do |r|
...
hydrodynamic = Catalog::SpecialRule.find_or_create_by!(name: "Hydrodynamic") do |r|
  r.description = "This character increases its DEXTERITY to 5 while in water."
end
bankroll = Catalog::SpecialRule.find_or_create_by!(name: "Bankroll") do |r|
...
brain_leech = Catalog::SpecialRule.find_or_create_by!(name: "Brain Leech") do |r|
...
lunar_might = Catalog::SpecialRule.find_or_create_by!(name: "Lunar Might") do |r|
...
devourer_of_will = Catalog::SpecialRule.find_or_create_by!(name: "Devourer of Will") do |r|
...
soothsaying = Catalog::SpecialRule.find_or_create_by!(name: "Soothsaying") do |r|
...
premonition = Catalog::SpecialRule.find_or_create_by!(name: "Premonition") do |r|
  r.description = "Whenever rolling dice for this character, you may re-roll the Destiny Dice."
end

# ── Weapons ───────────────────────────────────────────────────────────────────

wallachian_halberd = Catalog::Weapon.find_or_create_by!(name: "Wallachian Halberd") { |w| w.range = 2; w.evasion = 0;  w.damage = 1;  w.penetration = -2; w.abilities = ["Two-handed"] }
...
talons             = Catalog::Weapon.find_or_create_by!(name: "Talons")             { |w| w.range = 0; w.evasion = 0;  w.damage = 1;  w.penetration = -3; w.abilities = [] }
longsword          = Catalog::Weapon.find_or_create_by!(name: "Longsword")          { |w| w.range = 0; w.evasion = 0;  w.damage = 1;  w.penetration = -1; w.abilities = [] }
monstrous_claws    = Catalog::Weapon.find_or_create_by!(name: "Monstrous Claws")    { |w| w.range = 0; w.evasion = 0;  w.damage = 2;  w.penetration = -2; w.abilities = [] }
baleful_screech    = Catalog::Weapon.find_or_create_by!(name: "Baleful Screech")    { |w| w.range = 6; w.evasion = -2; w.damage = 0;  w.penetration = 0;  w.abilities = ["Blast", "Harmless", "Stun"] }
webbed_talons      = Catalog::Weapon.find_or_create_by!(name: "Webbed Talons")      { |w| w.range = 0; w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = ["Aquatic"] }
distended_jaws     = Catalog::Weapon.find_or_create_by!(name: "Distended Jaws")     { |w| w.range = 0; w.evasion = 1;  w.damage = 0;  w.penetration = -3; w.abilities = [] }
...
clawed_hands       = Catalog::Weapon.find_or_create_by!(name: "Clawed Hands")       { |w| w.range = 0; w.evasion = 0;  w.damage = 1;  w.penetration = -2; w.abilities = [] }
a_thousand_teeth   = Catalog::Weapon.find_or_create_by!(name: "A Thousand Teeth")   { |w| w.range = 0; w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = ["Aquatic"] }
brutal_claws       = Catalog::Weapon.find_or_create_by!(name: "Brutal Claws")       { |w| w.range = 0; w.evasion = -1; w.damage = 0;  w.penetration = -3; w.abilities = [] }
...
coustille          = Catalog::Weapon.find_or_create_by!(name: "Coustille")          { |w| w.range = 0; w.evasion = 0;  w.damage = 1;  w.penetration = -1; w.abilities = [] }

# ── Leaders ───────────────────────────────────────────────────────────────────

vlad_dracula = Catalog::Profile.find_or_create_by!(name: "Vlad Dracula") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: vlad_dracula, weapon: wallachian_halberd) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: vlad_dracula, special_rule: transformation)   { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: vlad_dracula, special_rule: master_bloodline) { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: vlad_dracula, special_rule: connoisseur)      { |psr| psr.position = 2 }

blood_crone = Catalog::Profile.find_or_create_by!(name: "Blood Crone") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: blood_crone, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: blood_crone, special_rule: clairvoyancy)    { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: blood_crone, special_rule: major_arcana)    { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: blood_crone, special_rule: minor_incantata) { |psr| psr.position = 2 }

noble_strigoi = Catalog::Profile.find_or_create_by!(name: "Noble Strigoi") do |p|
...
Catalog::ProfileWeapon.find_or_create_by!(profile: noble_strigoi, weapon: fangs) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: noble_strigoi, special_rule: blood_frenzy)      { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: noble_strigoi, special_rule: bloodline)         { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: noble_strigoi, special_rule: sanguine_sabotage) { |psr| psr.position = 2 }

stryha_crone = Catalog::Profile.find_or_create_by!(name: "Stryha Crone") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: stryha_crone, weapon: talons) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: stryha_crone, special_rule: natural_camouflage) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: stryha_crone, special_rule: carrion)            { |psr| psr.position = 1 }

wallachian_hospodar = Catalog::Profile.find_or_create_by!(name: "Wallachian Hospodar") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: wallachian_hospodar, weapon: longsword) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: wallachian_hospodar, special_rule: defensive_lines) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: wallachian_hospodar, special_rule: warlord)         { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: wallachian_hospodar, special_rule: full_plate)      { |psr| psr.position = 2 }

# ── Heroes ────────────────────────────────────────────────────────────────────

ceres = Catalog::Profile.find_or_create_by!(name: "Ceres") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: ceres, weapon: fangs) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ceres, special_rule: romani_fury)          { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ceres, special_rule: procession_of_brides) { |psr| psr.position = 1 }

cibele = Catalog::Profile.find_or_create_by!(name: "Cibele") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 12; p.will_points = 0; p.command_points = 1
  p.size = 30; p.ducats = 19; p.movement = 5; p.dexterity = 5; p.attack = 4; p.protection = 2; p.mind = 5
...
Catalog::ProfileWeapon.find_or_create_by!(profile: cibele, weapon: fangs) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: cibele, special_rule: african_bewitching)   { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: cibele, special_rule: procession_of_brides) { |psr| psr.position = 1 }

miriam = Catalog::Profile.find_or_create_by!(name: "Miriam") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: miriam, weapon: fangs) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: miriam, special_rule: eastern_swiftness)    { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: miriam, special_rule: procession_of_brides) { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: miriam, special_rule: sisters_of_gelo)      { |psr| psr.position = 2 }

monstrous_stryx = Catalog::Profile.find_or_create_by!(name: "Monstrous Stryx") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: monstrous_stryx, weapon: monstrous_claws) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: monstrous_stryx, weapon: baleful_screech)  { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: monstrous_stryx, special_rule: aerial_aggression) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: monstrous_stryx, special_rule: serpentine)        { |psr| psr.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: monstrous_stryx, special_rule: rip_and_tear)      { |psr| psr.position = 2 }

aquatic_strigoi = Catalog::Profile.find_or_create_by!(name: "Aquatic Strigoi") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: cetean_upior, weapon: distended_jaws) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: cetean_upior, special_rule: hydrodynamic) { |psr| psr.position = 0 }

highborn_servant = Catalog::Profile.find_or_create_by!(name: "Highborn Servant") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: highborn_servant, weapon: pistol) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: highborn_servant, weapon: sword)  { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: highborn_servant, special_rule: bankroll) { |psr| psr.position = 0 }

hulking_moroi = Catalog::Profile.find_or_create_by!(name: "Hulking Moroi") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: hulking_moroi, weapon: clawed_hands) { |pw| pw.position = 0 }

leech = Catalog::Profile.find_or_create_by!(name: "Leech") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: leech, weapon: a_thousand_teeth) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: leech, special_rule: brain_leech) { |psr| psr.position = 0 }

moon_eater = Catalog::Profile.find_or_create_by!(name: "Moon Eater") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: moon_eater, weapon: brutal_claws) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: moon_eater, special_rule: lunar_might)      { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: moon_eater, special_rule: devourer_of_will) { |psr| psr.position = 1 }

reaper = Catalog::Profile.find_or_create_by!(name: "Reaper") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 12; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: reaper, weapon: fangs) { |pw| pw.position = 0 }

seer = Catalog::Profile.find_or_create_by!(name: "Seer") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: seer, weapon: staff) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: seer, special_rule: soothsaying) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: seer, special_rule: premonition)  { |psr| psr.position = 1 }

spatar = Catalog::Profile.find_or_create_by!(name: "Spatar") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: spatar, weapon: flanged_mace) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: spatar, weapon: coustille)    { |pw| pw.position = 1 }

# ── Special Rules (cont.) ─────────────────────────────────────────────────────

judgement = Catalog::SpecialRule.find_or_create_by!(name: "Judgement") do |r|
...
cast_sentence = Catalog::SpecialRule.find_or_create_by!(name: "Cast Sentence") do |r|
...
devil_incarnate = Catalog::SpecialRule.find_or_create_by!(name: "Devil Incarnate") do |r|
...
crimson_feast = Catalog::SpecialRule.find_or_create_by!(name: "Crimson Feast") do |r|
...
minor_arcana = Catalog::SpecialRule.find_or_create_by!(name: "Minor Arcana") do |r|
...
cartomancy = Catalog::SpecialRule.find_or_create_by!(name: "Cartomancy") do |r|
...
impaler = Catalog::SpecialRule.find_or_create_by!(name: "Impaler") do |r|
...
the_end_is_near = Catalog::SpecialRule.find_or_create_by!(name: "The End is Near") do |r|
...
dredge = Catalog::SpecialRule.find_or_create_by!(name: "Dredge") do |r|
...
shadow_walker = Catalog::SpecialRule.find_or_create_by!(name: "Shadow Walker") do |r|
...
tarot = Catalog::SpecialRule.find_or_create_by!(name: "Tarot") do |r|
...
dead_weights = Catalog::SpecialRule.find_or_create_by!(name: "Dead Weights") do |r|
...
rejuvenated = Catalog::SpecialRule.find_or_create_by!(name: "Rejuvenated") do |r|
...
bloodletting = Catalog::SpecialRule.find_or_create_by!(name: "Bloodletting") do |r|
...
gavel           = Catalog::Weapon.find_or_create_by!(name: "Gavel")           { |w| w.range = 0; w.evasion = 0;  w.damage = 0; w.penetration = 0;  w.abilities = [] }
meathook        = Catalog::Weapon.find_or_create_by!(name: "Meathook")        { |w| w.range = 0; w.evasion = 0;  w.damage = 0; w.penetration = -1; w.abilities = [] }
canine_claws    = Catalog::Weapon.find_or_create_by!(name: "Canine Claws")    { |w| w.range = 0; w.evasion = 0;  w.damage = 0; w.penetration = -2; w.abilities = [] }
impaling_stake  = Catalog::Weapon.find_or_create_by!(name: "Impaling Stake")  { |w| w.range = 2; w.evasion = 0;  w.damage = 2; w.penetration = -1; w.abilities = ["Two-handed"] }
calcified_fists = Catalog::Weapon.find_or_create_by!(name: "Calcified Fists") { |w| w.range = 0; w.evasion = 1;  w.damage = 1; w.penetration = 0;  w.abilities = ["Stun"] }
fresh_claws     = Catalog::Weapon.find_or_create_by!(name: "Fresh Claws")     { |w| w.range = 0; w.evasion = -1; w.damage = 0; w.penetration = -1; w.abilities = [] }
sica            = Catalog::Weapon.find_or_create_by!(name: "Sica")            { |w| w.range = 0; w.evasion = 0;  w.damage = 0; w.penetration = -1; w.abilities = [] }
oar             = Catalog::Weapon.find_or_create_by!(name: "Oar")             { |w| w.range = 2; w.evasion = 0;  w.damage = 1; w.penetration = 1;  w.abilities = ["Two-handed"] }
spear           = Catalog::Weapon.find_or_create_by!(name: "Spear")           { |w| w.range = 2; w.evasion = 0;  w.damage = 1; w.penetration = 0;  w.abilities = ["Two-handed", "Knockback"] }
ancient_claws   = Catalog::Weapon.find_or_create_by!(name: "Ancient Claws")   { |w| w.range = 0; w.evasion = 0;  w.damage = 0; w.penetration = -2; w.abilities = [] }
knife           = Catalog::Weapon.find_or_create_by!(name: "Knife")           { |w| w.range = 0; w.evasion = 0;  w.damage = 0; w.penetration = 0;  w.abilities = [] }
claws           = Catalog::Weapon.find_or_create_by!(name: "Claws")           { |w| w.range = 0; w.evasion = 0;  w.damage = 1; w.penetration = -1; w.abilities = ["Aquatic"] }
...
sinking_weights = Catalog::Weapon.find_or_create_by!(name: "Sinking Weights") { |w| w.range = 2; w.evasion = 0;  w.damage = 2; w.penetration =  0; w.abilities = ["Knockback"] }
short_bow       = Catalog::Weapon.find_or_create_by!(name: "Short Bow")       { |w| w.range = 12; w.evasion = 0; w.damage = 0; w.penetration =  0; w.abilities = ["Two-handed", "Reload (3)"] }

# ── Heroes (cont.) ────────────────────────────────────────────────────────────

strige = Catalog::Profile.find_or_create_by!(name: "Strige") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: strige, weapon: fangs) { |pw| pw.position = 0 }

strigoi_jude = Catalog::Profile.find_or_create_by!(name: "Strigoi Jude") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 12; p.will_points = 0; p.command_points = 1
...
Catalog::ProfileWeapon.find_or_create_by!(profile: strigoi_jude, weapon: gavel) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: strigoi_jude, special_rule: judgement)     { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: strigoi_jude, special_rule: cast_sentence) { |psr| psr.position = 1 }

strigoi_priest = Catalog::Profile.find_or_create_by!(name: "Strigoi Priest") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 12; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: strigoi_priest, weapon: fangs) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: strigoi_priest, special_rule: devil_incarnate) { |psr| psr.position = 0 }

strigoi_sluger = Catalog::Profile.find_or_create_by!(name: "Strigoi Sluger") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: strigoi_sluger, weapon: meathook) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: strigoi_sluger, special_rule: crimson_feast) { |psr| psr.position = 0 }

strzyga = Catalog::Profile.find_or_create_by!(name: "Strzyga") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 15; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: strzyga, weapon: monstrous_claws) { |pw| pw.position = 0 }

tarot_reader = Catalog::Profile.find_or_create_by!(name: "Tarot Reader") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: tarot_reader, weapon: unarmed) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: tarot_reader, special_rule: minor_arcana) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: tarot_reader, special_rule: cartomancy)   { |psr| psr.position = 1 }

varcolac = Catalog::Profile.find_or_create_by!(name: "Varcolac") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: varcolac, weapon: canine_claws) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: varcolac, special_rule: lunar_might) { |psr| psr.position = 0 }

wallachian_impaler = Catalog::Profile.find_or_create_by!(name: "Wallachian Impaler") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 14; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: wallachian_impaler, weapon: impaling_stake) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: wallachian_impaler, special_rule: impaler) { |psr| psr.position = 0 }

zoryi = Catalog::Profile.find_or_create_by!(name: "Zoryi") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: zoryi, weapon: calcified_fists) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: zoryi, weapon: fresh_claws)     { |pw| pw.position = 1 }
...
Catalog::ProfileWeapon.find_or_create_by!(profile: al_naibii, weapon: sica) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: al_naibii, special_rule: the_end_is_near) { |psr| psr.position = 0 }

common_strigoi = Catalog::Profile.find_or_create_by!(name: "Common Strigoi") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: common_strigoi, weapon: fangs) { |pw| pw.position = 0 }

ferryman = Catalog::Profile.find_or_create_by!(name: "Ferryman") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: ferryman, weapon: oar) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ferryman, special_rule: sculler) { |psr| psr.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: ferryman, special_rule: dredge)  { |psr| psr.position = 1 }

giurgiu_guard = Catalog::Profile.find_or_create_by!(name: "Giurgiu Guard") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 12; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: giurgiu_guard, weapon: spear) { |pw| pw.position = 0 }

harpy = Catalog::Profile.find_or_create_by!(name: "Harpy") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: harpy, weapon: fangs) { |pw| pw.position = 0 }

newborn_strigoi = Catalog::Profile.find_or_create_by!(name: "Newborn Strigoi") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 8; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: newborn_strigoi, weapon: fangs) { |pw| pw.position = 0 }

nosferatu = Catalog::Profile.find_or_create_by!(name: "Nosferatu") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: nosferatu, weapon: ancient_claws) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: nosferatu, special_rule: shadow_walker) { |psr| psr.position = 0 }

romani = Catalog::Profile.find_or_create_by!(name: "Romani") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: romani, weapon: knife) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: romani, special_rule: tarot) { |psr| psr.position = 0 }

rotter = Catalog::Profile.find_or_create_by!(name: "Rotter") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 12; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: rotter, weapon: claws) { |pw| pw.position = 0 }

targoveti = Catalog::Profile.find_or_create_by!(name: "Targoveti") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 11; p.will_points = 1; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: targoveti, weapon: battle_axe) { |pw| pw.position = 0 }

thrall = Catalog::Profile.find_or_create_by!(name: "Thrall") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
...
Catalog::ProfileWeapon.find_or_create_by!(profile: thrall, weapon: crossbow) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: thrall, weapon: club)     { |pw| pw.position = 1 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: thrall, special_rule: bloodletting) { |psr| psr.position = 0 }

sinker = Catalog::Profile.find_or_create_by!(name: "Sinker") do |p|
  p.version = "2.4.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 10; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: sinker, weapon: sinking_weights) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: sinker, special_rule: dead_weights) { |psr| psr.position = 0 }

starved_dhampir = Catalog::Profile.find_or_create_by!(name: "Starved Dhampir") do |p|
  p.version = "2.3.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 10; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: starved_dhampir, weapon: fangs) { |pw| pw.position = 0 }
Catalog::ProfileSpecialRule.find_or_create_by!(profile: starved_dhampir, special_rule: rejuvenated) { |psr| psr.position = 0 }

poenari_scout = Catalog::Profile.find_or_create_by!(name: "Poenari Scout") do |p|
  p.version = "2.2.0"; p.faction = "strigoi"
  p.action_points = 2; p.life_points = 10; p.will_points = 0; p.command_points = 0
...
Catalog::ProfileWeapon.find_or_create_by!(profile: poenari_scout, weapon: short_bow) { |pw| pw.position = 0 }
Catalog::ProfileWeapon.find_or_create_by!(profile: poenari_scout, weapon: fangs)     { |pw| pw.position = 1 }
...
# Pages 30-33, 35-38, 41-42 produced _a/_b variants; _a is used as primary.
{
  ...
  profile = Catalog::Profile.find_by(faction: "strigoi", name: name)
  next unless profile
...
# ── Card References ────────────────────────────────────────────────────────────
profile_map = Catalog::Profile.where(faction: "strigoi").each_with_object({}) { |p, h| h[p.name] = p.id }
now = Time.current
...
p_count  = Catalog::Profile.where(faction: "strigoi").count
