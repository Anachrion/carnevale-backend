...
stage_manager = SpecialRule.find_or_create_by!(name: "Stage Manager") do |r|
...
troupe_leader = SpecialRule.find_or_create_by!(name: "Troupe Leader") do |r|
...
search_of_satisfaction = SpecialRule.find_or_create_by!(name: "Search of Satisfaction") do |r|
...
cheat = SpecialRule.find_or_create_by!(name: "Cheat") do |r|
...
all_eyes_on_me = SpecialRule.find_or_create_by!(name: "All Eyes On Me") do |r|
...
disappear = SpecialRule.find_or_create_by!(name: "Disappear - 2AP") do |r|
...
inspiring_hero = SpecialRule.find_or_create_by!(name: "Inspiring Hero") do |r|
...
slavering_horror = SpecialRule.find_or_create_by!(name: "Slavering Horror") do |r|
...
fanged_visage = SpecialRule.find_or_create_by!(name: "Fanged Visage") do |r|
...
supernatural = SpecialRule.find_or_create_by!(name: "Supernatural") do |r|
...
diminutive = SpecialRule.find_or_create_by!(name: "Diminutive") do |r|
...
protective_bubble = SpecialRule.find_or_create_by!(name: "Protective Bubble - 1AP") do |r|
...
the_other_side_of_the_coin = SpecialRule.find_or_create_by!(name: "The Other Side of the Coin - 1AP") do |r|
  r.description = "If both Fate and Justice are on the board (as friendly characters), swap their positions."
end
aura_of_inevitability = SpecialRule.find_or_create_by!(name: "Aura of Inevitability - 1AP") do |r|
...
take_the_oath = SpecialRule.find_or_create_by!(name: "Take the Oath") do |r|
...
a_light_in_the_dark = SpecialRule.find_or_create_by!(name: "A Light in the Dark") do |r|
...
reflected_reality = SpecialRule.find_or_create_by!(name: "Reflected Reality") do |r|
...
mischievous = SpecialRule.find_or_create_by!(name: "Mischievous") do |r|
...
maximum_fastness = SpecialRule.find_or_create_by!(name: "Maximum Fastness") do |r|
...
mask_of_many_faces = SpecialRule.find_or_create_by!(name: "Mask of Many Faces") do |r|
...
till_death_do_us_part = SpecialRule.find_or_create_by!(name: "Till Death Do Us Part") do |r|
  r.description = "When this character is reduced to 5 Life Points or less, it gains +2 ATTACK and Mindless."
end
justice_served = SpecialRule.find_or_create_by!(name: "Justice Served") do |r|
...
the_mask_makes_the_noble = SpecialRule.find_or_create_by!(name: "The Mask Makes the Noble") do |r|
...
armourer = SpecialRule.find_or_create_by!(name: "Armourer") do |r|
...
creative_creation = SpecialRule.find_or_initialize_by(spell_name: "Creative Creation").tap do |r|
  r.name             = ""
...
watered_down = SpecialRule.find_or_create_by!(name: "Watered Down") do |r|
  r.description = "At the end of the round, if this character is in water, it is killed."
end
work_of_art = SpecialRule.find_or_create_by!(name: "Work of Art") do |r|
...
undying_deathseeker = SpecialRule.find_or_create_by!(name: "Undying Deathseeker") do |r|
...
ronin = SpecialRule.find_or_create_by!(name: "Ronin") do |r|
  r.description = "This character cannot receive ORDER or COUNTER Commands."
end
hofuku_kogeki = SpecialRule.find_or_create_by!(name: "Hōfuku Kōgeki") do |r|
...
mask_of_dagon = SpecialRule.find_or_create_by!(name: "Mask of Dagon") do |r|
...
split_personalities = SpecialRule.find_or_create_by!(name: "Split Personalities") do |r|
...
blinding_flash = SpecialRule.find_or_create_by!(name: "Blinding Flash - 2AP") do |r|
...
self_immolate = SpecialRule.find_or_create_by!(name: "Self-Immolate") do |r|
...
always_scheming = SpecialRule.find_or_create_by!(name: "Always Scheming") do |r|
...
all_according_to_plan = SpecialRule.find_or_create_by!(name: "All According to Plan") do |r|
...
annoying_tune = SpecialRule.find_or_create_by!(name: "Annoying Tune") do |r|
...
deathwish = SpecialRule.find_or_create_by!(name: "Deathwish") do |r|
...
shattered_nexus = SpecialRule.find_or_create_by!(name: "Shattered Nexus") do |r|
...
bored_to_inaction = SpecialRule.find_or_create_by!(name: "Bored to Inaction") do |r|
...
vindictive = SpecialRule.find_or_create_by!(name: "Vindictive") do |r|
...
hoarded_wealth = SpecialRule.find_or_create_by!(name: "Hoarded Wealth") do |r|
...
confusing_exit = SpecialRule.find_or_create_by!(name: "Confusing Exit") do |r|
...
thirsty = SpecialRule.find_or_create_by!(name: "Thirsty") do |r|
...
everyman = SpecialRule.find_or_create_by!(name: "Everyman") do |r|
...
costume_pistol   = Weapon.find_or_create_by!(name: "Costume Pistol")   { |w| w.range = 6;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Black Powder", "Harmless", "Knockback"] }
...
monstrous_tentacles = Weapon.find_or_create_by!(name: "Monstrous Tentacles") { |w| w.range = 3; w.evasion = 1; w.damage = 1; w.penetration = 0; w.abilities = ["Stun"] }
spectral_touch   = Weapon.find_or_create_by!(name: "Spectral Touch")   { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
carving_knife    = Weapon.find_or_create_by!(name: "Carving Knife")    { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
unarmed          = Weapon.find_or_create_by!(name: "Unarmed")          { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 1;  w.abilities = [] }
book_of_destiny  = Weapon.find_or_create_by!(name: "Book of Destiny")  { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
shattered_touch  = Weapon.find_or_create_by!(name: "Shattered Touch")  { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = -4; w.abilities = [] }
stiletto         = Weapon.find_or_create_by!(name: "Stiletto")         { |w| w.range = 0;  w.evasion = 0;  w.damage = 1;  w.penetration = 1;  w.abilities = [] }
sword_of_balance = Weapon.find_or_create_by!(name: "Sword of Balance") { |w| w.range = 1;  w.evasion = 0;  w.damage = 1;  w.penetration = -4; w.abilities = ["Two-handed"] }
forge_hammer     = Weapon.find_or_create_by!(name: "Forge Hammer")     { |w| w.range = 0;  w.evasion = 1;  w.damage = 1;  w.penetration = 0;  w.abilities = [] }
paintbrush       = Weapon.find_or_create_by!(name: "Paintbrush")       { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 1;  w.abilities = [] }
daisho           = Weapon.find_or_create_by!(name: "Daishō")           { |w| w.range = 0;  w.evasion = -1; w.damage = 1;  w.penetration = -1; w.abilities = [] }
bronze_chisel    = Weapon.find_or_create_by!(name: "Bronze Chisel")    { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Aquatic"] }
pliers           = Weapon.find_or_create_by!(name: "Pliers")           { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
doves_kiss       = Weapon.find_or_create_by!(name: "Dove's Kiss")      { |w| w.range = 8;  w.evasion = 1;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Knockback", "Reload (2)"] }
fireball         = Weapon.find_or_create_by!(name: "Fireball")         { |w| w.range = 8;  w.evasion = 0;  w.damage = 2;  w.penetration = -2; w.abilities = ["Black Powder", "Two-handed", "Reload (2)"] }
fiery_explosion  = Weapon.find_or_create_by!(name: "Fiery Explosion")  { |w| w.range = 0;  w.evasion = 0;  w.damage = 2;  w.penetration = -7; w.abilities = ["Black Powder", "Blast", "Reload (1)"] }
atrezzo_crossbow = Weapon.find_or_create_by!(name: "Atrezzo Crossbow") { |w| w.range = 30; w.evasion = 0;  w.damage = 0;  w.penetration = -1; w.abilities = ["Reload (2)", "Two-handed"] }
gilded_mirror    = Weapon.find_or_create_by!(name: "Gilded Mirror")    { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
prop_sword       = Weapon.find_or_create_by!(name: "Prop Sword")       { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = [] }
bomb             = Weapon.find_or_create_by!(name: "Bomb")             { |w| w.range = 6;  w.evasion = 1;  w.damage = 2;  w.penetration = 0;  w.abilities = ["Black Powder", "Blast", "Reload (1)"] }
tentacled_rebar  = Weapon.find_or_create_by!(name: "Tentacled Rebar")  { |w| w.range = 1;  w.evasion = 1;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Knockback"] }
wine_bottle      = Weapon.find_or_create_by!(name: "Wine Bottle")      { |w| w.range = 0;  w.evasion = 0;  w.damage = 0;  w.penetration = 0;  w.abilities = ["Stun"] }
...
fanged_tentacles = Weapon.find_or_create_by!(name: "Fanged Tentacles") { |w| w.range = 2;  w.evasion = 0;  w.damage = 1;  w.penetration = 0;  w.abilities = ["Aquatic"] }
...
claws_gifted = Weapon.where(name: "Claws").detect { |w| w.abilities == [] } ||
               Weapon.create!(name: "Claws", range: 0, evasion: 0, damage: 0, penetration: -1, abilities: [])
# Francisco's Scalpel is penetration 0, unlike the Doctors' Scalpel (penetration -1).
scalpel_gifted = Weapon.find_or_create_by!(name: "Scalpel", penetration: 0) { |w| w.range = 0; w.evasion = 0; w.damage = 0; w.abilities = [] }

# ── Leaders ───────────────────────────────────────────────────────────────────

il_capitano = Profile.find_or_create_by!(name: "Il Capitano") do |p|
...
ProfileWeapon.find_or_create_by!(profile: il_capitano, weapon: greatsword) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: il_capitano, special_rule: stage_manager) { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: il_capitano, special_rule: troupe_leader) { |psr| psr.position = 1 }

la_signora = Profile.find_or_create_by!(name: "La Signora") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: la_signora, weapon: costume_pistol) { |pw| pw.position = 0 }
ProfileWeapon.find_or_create_by!(profile: la_signora, weapon: rapier)         { |pw| pw.position = 1 }
ProfileSpecialRule.find_or_create_by!(profile: la_signora, special_rule: search_of_satisfaction) { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: la_signora, special_rule: cheat)          { |psr| psr.position = 1 }
ProfileSpecialRule.find_or_create_by!(profile: la_signora, special_rule: all_eyes_on_me) { |psr| psr.position = 2 }

the_duke = Profile.find_or_create_by!(name: "The Duke") do |p|
...
ProfileWeapon.find_or_create_by!(profile: the_duke, weapon: pistol) { |pw| pw.position = 0 }
ProfileWeapon.find_or_create_by!(profile: the_duke, weapon: sword)  { |pw| pw.position = 1 }
ProfileSpecialRule.find_or_create_by!(profile: the_duke, special_rule: disappear)      { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: the_duke, special_rule: inspiring_hero) { |psr| psr.position = 1 }

# ── Heroes ────────────────────────────────────────────────────────────────────

the_aberration = Profile.find_or_create_by!(name: "The Aberration") do |p|
...
ProfileWeapon.find_or_create_by!(profile: the_aberration, weapon: monstrous_tentacles) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: the_aberration, special_rule: slavering_horror) { |psr| psr.position = 0 }

artisan_elena = Profile.find_or_create_by!(name: "Artisan Elena") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: artisan_elena, weapon: claws_gifted) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: artisan_elena, special_rule: fanged_visage) { |psr| psr.position = 0 }

black_spectre = Profile.find_or_create_by!(name: "Black Spectre") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: black_spectre, weapon: spectral_touch) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: black_spectre, special_rule: supernatural) { |psr| psr.position = 0 }

burattino = Profile.find_or_create_by!(name: "Burattino") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: burattino, weapon: carving_knife) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: burattino, special_rule: diminutive) { |psr| psr.position = 0 }

fadhila = Profile.find_or_create_by!(name: "Fadhila") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: fadhila, weapon: unarmed) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: fadhila, special_rule: protective_bubble) { |psr| psr.position = 0 }

fate = Profile.find_or_create_by!(name: "Fate") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: fate, weapon: book_of_destiny) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: fate, special_rule: the_other_side_of_the_coin) { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: fate, special_rule: aura_of_inevitability)      { |psr| psr.position = 1 }

francisco_de_lorme = Profile.find_or_create_by!(name: "Francisco De Lorme") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: francisco_de_lorme, weapon: scalpel_gifted) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: francisco_de_lorme, special_rule: take_the_oath) { |psr| psr.position = 0 }

harbingers_reflection = Profile.find_or_create_by!(name: "Harbinger's Reflection") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 10; p.will_points = 4; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: harbingers_reflection, weapon: shattered_touch) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: harbingers_reflection, special_rule: a_light_in_the_dark) { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: harbingers_reflection, special_rule: reflected_reality)   { |psr| psr.position = 1 }

harlequin = Profile.find_or_create_by!(name: "Harlequin") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: harlequin, weapon: sword) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: harlequin, special_rule: mischievous)      { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: harlequin, special_rule: maximum_fastness) { |psr| psr.position = 1 }

il_mentore = Profile.find_or_create_by!(name: "Il Mentore") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: il_mentore, weapon: stiletto) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: il_mentore, special_rule: mask_of_many_faces) { |psr| psr.position = 0 }

innamorati = Profile.find_or_create_by!(name: "Innamorati") do |p|
  p.version = "2.2.1"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: innamorati, weapon: pistol) { |pw| pw.position = 0 }
ProfileWeapon.find_or_create_by!(profile: innamorati, weapon: sword)  { |pw| pw.position = 1 }
ProfileSpecialRule.find_or_create_by!(profile: innamorati, special_rule: till_death_do_us_part) { |psr| psr.position = 0 }

justice = Profile.find_or_create_by!(name: "Justice") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 14; p.will_points = 5; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: justice, weapon: sword_of_balance) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: justice, special_rule: the_other_side_of_the_coin) { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: justice, special_rule: justice_served)             { |psr| psr.position = 1 }

marco_leontus = Profile.find_or_create_by!(name: "Marco Leontus") do |p|
...
ProfileWeapon.find_or_create_by!(profile: marco_leontus, weapon: pistol) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: marco_leontus, special_rule: the_mask_makes_the_noble) { |psr| psr.position = 0 }

master_gerhard = Profile.find_or_create_by!(name: "Master Gerhard") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 12; p.will_points = 2; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: master_gerhard, weapon: forge_hammer) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: master_gerhard, special_rule: armourer) { |psr| psr.position = 0 }

maria_fioritura = Profile.find_or_create_by!(name: "Maria Fioritura") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: maria_fioritura, weapon: paintbrush) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: maria_fioritura, special_rule: creative_creation) { |psr| psr.position = 0 }

painted_protector = Profile.find_or_create_by!(name: "Painted Protector") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: painted_protector, weapon: sword) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: painted_protector, special_rule: watered_down) { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: painted_protector, special_rule: work_of_art)   { |psr| psr.position = 1 }

senshi = Profile.find_or_create_by!(name: "Senshi the Undying") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: senshi, weapon: daisho) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: senshi, special_rule: undying_deathseeker) { |psr| psr.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: senshi, special_rule: ronin)               { |psr| psr.position = 1 }
ProfileSpecialRule.find_or_create_by!(profile: senshi, special_rule: hofuku_kogeki)       { |psr| psr.position = 2 }

solus_hydraea = Profile.find_or_create_by!(name: "Solus Hydraea") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: solus_hydraea, weapon: bronze_chisel) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: solus_hydraea, special_rule: mask_of_dagon) { |psr| psr.position = 0 }

mask_maker = Profile.find_or_create_by!(name: "The Mask Maker") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: mask_maker, weapon: pliers) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: mask_maker, special_rule: split_personalities) { |psr| psr.position = 0 }

white_dove = Profile.find_or_create_by!(name: "White Dove") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: white_dove, weapon: doves_kiss) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: white_dove, special_rule: blinding_flash) { |psr| psr.position = 0 }

zovena_vela = Profile.find_or_create_by!(name: "Zovena Vela") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 10; p.will_points = 4; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: zovena_vela, weapon: fireball)        { |pw| pw.position = 0 }
ProfileWeapon.find_or_create_by!(profile: zovena_vela, weapon: fiery_explosion) { |pw| pw.position = 1 }
ProfileSpecialRule.find_or_create_by!(profile: zovena_vela, special_rule: self_immolate) { |psr| psr.position = 0 }

# ── Henchmen ──────────────────────────────────────────────────────────────────

brighella = Profile.find_or_create_by!(name: "Brighella") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 11; p.will_points = 2; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: brighella, weapon: atrezzo_crossbow) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: brighella, special_rule: always_scheming) { |psr| psr.position = 0 }

colombina = Profile.find_or_create_by!(name: "Colombina") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 11; p.will_points = 2; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: colombina, weapon: gilded_mirror) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: colombina, special_rule: all_according_to_plan) { |psr| psr.position = 0 }

coviello = Profile.find_or_create_by!(name: "Coviello") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
...
ProfileWeapon.find_or_create_by!(profile: coviello, weapon: prop_sword) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: coviello, special_rule: annoying_tune) { |psr| psr.position = 0 }

demolitionist = Profile.find_or_create_by!(name: "The Demolitionist") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 11; p.will_points = 2; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: demolitionist, weapon: bomb) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: demolitionist, special_rule: deathwish) { |psr| psr.position = 0 }

escaped_madman = Profile.find_or_create_by!(name: "Escaped Madman") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 14; p.will_points = 3; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: escaped_madman, weapon: tentacled_rebar) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: escaped_madman, special_rule: shattered_nexus) { |psr| psr.position = 0 }

il_dottore = Profile.find_or_create_by!(name: "Il Dottore") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 12; p.will_points = 2; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: il_dottore, weapon: wine_bottle) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: il_dottore, special_rule: bored_to_inaction) { |psr| psr.position = 0 }

mezzetino = Profile.find_or_create_by!(name: "Mezzetino") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 11; p.will_points = 2; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: mezzetino, weapon: sword) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: mezzetino, special_rule: vindictive) { |psr| psr.position = 0 }

pantaleone = Profile.find_or_create_by!(name: "Pantaleone") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 10; p.will_points = 2; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: pantaleone, weapon: smoke_bomb) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: pantaleone, special_rule: hoarded_wealth) { |psr| psr.position = 0 }

scapino = Profile.find_or_create_by!(name: "Scapino") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 10; p.will_points = 2; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: scapino, weapon: unarmed) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: scapino, special_rule: confusing_exit) { |psr| psr.position = 0 }

starspawn = Profile.find_or_create_by!(name: "Starspawn") do |p|
  p.version = "2.3.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 14; p.will_points = 3; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: starspawn, weapon: fanged_tentacles) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: starspawn, special_rule: thirsty) { |psr| psr.position = 0 }

pierrot = Profile.find_or_create_by!(name: "Pierrot") do |p|
  p.version = "2.2.0"; p.faction = "gifted"
  p.action_points = 2; p.life_points = 8; p.will_points = 0; p.command_points = 0
...
ProfileWeapon.find_or_create_by!(profile: pierrot, weapon: unarmed) { |pw| pw.position = 0 }
ProfileSpecialRule.find_or_create_by!(profile: pierrot, special_rule: everyman) { |psr| psr.position = 0 }
...
# Page 36 produced _a through _g variants (Pierrot is a multi-copy henchman); _a is used.
{
  ...
  profile = Profile.find_by(faction: "gifted", name: name)
  next unless profile
