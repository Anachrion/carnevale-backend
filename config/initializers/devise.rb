...
Devise.setup do |config|
  ...
  # config.secret_key = '2e1494eec2829fb62bb9eebe2032134ed38a8d89b8429d95ea1fa2113f00f00eaeda31b4e071fdd117343246147d8c5d8b435c2d3e2cc5f5c05930bf881167fe'
  ...
  config.mailer_sender = "no-reply@carnevale-app.com"
  ...
  # Enabled so password reset doesn't reveal which emails have accounts (B-20); the API's
  # forgot-password endpoint already documents the always-succeeds contract this provides.
  ...
  # config.pepper = '856c4e51f85b3a6d149f24769b7781a026c621ecb9a8f0a5dc1d06720c7952f4100f306d17decbd2881a681bc48c095d5d557d75012a0200c9bae050baa069fe'
